...
import{n as e,r as t}from"./rolldown-runtime-hePW80VL.js";import{i as n}from"./exporter-D0ysRip3.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var r=`true`,i=`false`,a=r===`true`,o=i===`true`;function s(e={}){let{immediate:t=!1,onNeedReload:r,onNeedRefresh:i,onOfflineReady:s,onRegistered:c,onRegisteredSW:l,onRegisterError:u}=e,d,f,p,m=async(e=!0)=>{await f,a||p==null||p()};async function h(){if(`serviceWorker`in navigator){if(d=await n(async()=>{let{Workbox:e}=await import(`./workbox-window.prod.es5-zd_v-k4h.js`);return{Workbox:e}},[],import.meta.url).then(({Workbox:e})=>new e(`./sw.js`,{scope:`./`,type:`classic`})).catch(e=>{u==null||u(e)}),!d)return;if(p=()=>{d==null||d.messageSkipWaiting()},!o){if(a)d.addEventListener(`activated`,e=>{(e.isUpdate||e.isExternal)&&(r?r():window.location.reload())}),d.addEventListener(`installed`,e=>{e.isUpdate||s==null||s()});else{let e=!1,t=()=>{e=!0,d==null||d.addEventListener(`controlling`,e=>{e.isUpdate&&(r?r():window.location.reload())}),i==null||i()};d.addEventListener(`installed`,n=>{n.isUpdate===void 0?n.isExternal===void 0?!e&&(s==null||s()):n.isExternal?t():!e&&(s==null||s()):n.isUpdate||s==null||s()}),d.addEventListener(`waiting`,t)}}d.register({immediate:t}).then(e=>{l?l(`./sw.js`,e):c==null||c(e)}).catch(e=>{u==null||u(e)})}}return f=h(),m}function c(e=`id`){return e+`_`+Date.now().toString(36)+`_`+Math.random().toString(36).slice(2,8)}function l(e,t=300){let n;return(...r)=>{clearTimeout(n),n=setTimeout(()=>e(...r),t)}}function u(e){return String(e==null?``:e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function d(e){let t=document.createElement(`div`);return t.innerHTML=String(e==null?``:e),t.querySelectorAll(`script, iframe, object, embed, style, link, meta`).forEach(e=>e.remove()),t.querySelectorAll(`*`).forEach(e=>{[...e.attributes].forEach(t=>{t.name.toLowerCase().startsWith(`on`)&&e.removeAttribute(t.name),/^(href|src)$/i.test(t.name)&&/^\s*javascript:/i.test(t.value)&&e.removeAttribute(t.name)})}),t.innerHTML}function f(){return new Date().toISOString()}function p(){let e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function m(e){if(!e)return``;let t=new Date(e.length===10?e+`T00:00:00`:e);return isNaN(t)?e:t.toLocaleDateString(`th-TH`,{day:`numeric`,month:`short`,year:`numeric`})}function h(e){return e||``}function g(e,t){let n=[m(e)];return t&&n.push(t),n.join(` · `)}function _(e){if(!e)return``;let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4);if(n<1)return`just now`;if(n<60)return`${n}m ago`;let r=Math.floor(n/60);if(r<24)return`${r}h ago`;let i=Math.floor(r/24);return i<7?`${i}d ago`:m(e.slice(0,10))}var v={high:{label:`High`,tone:`error`,bar:`bg-error`,badge:`bg-error-container text-on-error-container border border-error/20`,dot:`bg-error`},medium:{label:`Medium`,tone:`tertiary`,bar:`bg-tertiary-container`,badge:`bg-tertiary-fixed text-on-tertiary-fixed border border-tertiary/20`,dot:`bg-tertiary-container`},low:{label:`Low`,tone:`secondary`,bar:`bg-secondary`,badge:`bg-secondary-fixed text-on-secondary-fixed border border-secondary/20`,dot:`bg-secondary`}};function y(e){return String(e||`?`).trim().split(/\s+/).slice(0,2).map(e=>e[0]).join(``).toUpperCase()}function b(){return navigator.onLine!==!1}var x=null,S=null;function C(e,t=``){return`<span class="material-symbols-outlined ${t}" aria-hidden="true">${e}</span>`}var w={show(e,t=`info`,n=3200){x||(x=document.createElement(`div`),x.className=`fixed left-1/2 -translate-x-1/2 z-[120] flex flex-col items-center gap-2 px-4 w-full max-w-md pointer-events-none`,x.style.bottom=`calc(88px + env(safe-area-inset-bottom, 0px))`,document.body.appendChild(x));let r=document.createElement(`div`),i={info:`bg-inverse-surface text-inverse-on-surface`,success:`bg-primary text-on-primary`,error:`bg-error text-on-error`,warn:`bg-tertiary-container text-on-tertiary-container`};r.className=`flex items-center gap-2 px-4 py-2.5 rounded-xl shadow-cardlg ${i[t]||i.info} fade-anim max-w-full`,r.innerHTML=`${C({info:`info`,success:`check_circle`,error:`error`,warn:`warning`}[t]||`info`,`text-[18px] shrink-0`)}<span class="text-sm font-medium leading-tight break-words">${u(e)}</span>`,x.appendChild(r),setTimeout(()=>{r.style.transition=`opacity .3s ease, transform .3s ease`,r.style.opacity=`0`,r.style.transform=`translateY(8px)`,setTimeout(()=>r.remove(),300)},n)}};function T(){return S||(S=document.createElement(`div`),S.id=`modal-root`,document.body.appendChild(S),S)}function ee(e){let t=T(),n=document.createElement(`div`);n.className=`fixed inset-0 z-[110] flex items-center justify-center p-4`,n.style.background=`rgba(0,0,0,.45)`,n.style.backdropFilter=`blur(4px)`,n.innerHTML=e,t.appendChild(n);let r=e=>{n.style.opacity=`0`,n.style.transition=`opacity .2s ease`,setTimeout(()=>n.remove(),200),n._resolve&&n._resolve(e)};return n._close=r,n.addEventListener(`click`,e=>{e.target===n&&r(null)}),n}var E={confirm({title:e,message:t,confirmText:n=`Confirm`,cancelText:r=`Cancel`,danger:i=!1,pin:a=null}){return new Promise(o=>{let s=ee(`
    ...
    </header>`}function K(e=`Back`){return`<button class="icon-btn -ml-2" data-back aria-label="${u(e)}">${C(`arrow_back`)}</button>`}function ve(e,t){return e?`<button class="w-9 h-9 rounded-full overflow-hidden border border-outline-variant shrink-0" data-avatar aria-label="Profile">
      <img src="${u(e)}" alt="${u(t||`Profile`)}" class="w-full h-full object-cover" loading="lazy" decoding="async" /></button>`:`<button class="w-9 h-9 rounded-full bg-primary-container text-on-primary-container flex items-center justify-center text-sm font-bold shrink-0" data-avatar aria-label="Profile">${u((t||`M`)[0].toUpperCase())}</button>`}var ye=[{key:`home`,label:`Home`,icon:`home`,href:`#/`},{key:`planner`,label:`Calendar`,icon:`calendar_today`,href:`#/planner`},{key:`projects`,label:`Projects`,icon:`folder`,href:`#/projects`},{key:`export`,label:`Export`,icon:`ios_share`,href:`#/export`},{key:`settings`,label:`Settings`,icon:`settings`,href:`#/settings`}];function q(e=`home`){return`
    ...
    </nav>`}function be(e,t=`Add`){return`<a href="${e}" class="fab bottom-6 right-6 md:bottom-8 md:right-8" aria-label="${t}">${C(`add`,`text-[26px]`)}</a>`}function xe(){let e=document.querySelector(`[data-sidebar]`);return e?(e.innerHTML=`
    ...
    </div>`,t=>{e.querySelectorAll(`[data-route]`).forEach(e=>{var n;let r=e.dataset.route===t;e.classList.toggle(`bg-primary-container`,r),e.classList.toggle(`text-on-primary-container`,r),e.classList.toggle(`text-on-surface-variant`,!r),e.classList.toggle(`hover:bg-surface-container-high`,!r),(n=e.querySelector(`span.material-symbols-outlined`))==null||n.classList.toggle(`font-bold`,r)})}):()=>{}}function Se(e){let t=String(e||`/`).replace(/^#/,``).split(`?`)[0];return t.startsWith(`/planner`)?`planner`:t.startsWith(`/projects`)?`projects`:t.startsWith(`/export`)?`export`:t.startsWith(`/settings`)?`settings`:`home`}function Ce(){let e=document.createElement(`div`);e.id=`sync-indicator`,e.className=`fixed left-1/2 -translate-x-1/2 z-[100] transition-all duration-300 pointer-events-none opacity-0`,e.style.bottom=`calc(76px + env(safe-area-inset-bottom, 0px))`,e.style.transform=`translate(-50%, 8px)`,e.style.display=`none`,document.body.appendChild(e);let t=0,n=0;function r(){let r=U.getOps(),a=r.filter(e=>e.status===`pending`||e.status===`running`).length,o=r.filter(e=>e.status===`error`).length,s=!U.isOnline(),c=n>0&&a===0&&o===0;n=a;let l=``;if(a>0)l=`<span class="inline-flex items-center gap-2 px-3.5 py-2 rounded-full bg-inverse-surface text-inverse-on-surface shadow-cardlg">
    ...
    </a>`}function Te(e,t={}){var n,r,i;let a=((n=v[e.priority])==null?void 0:n.bar)||v.medium.bar,o=(r=t.projectName)==null?e.projectId?(i=P.project(e.projectId))==null?void 0:i.name:null:r,s=g(e.date,e.time);return`
    ...
    <a href="#/meetings/${encodeURIComponent(e.id)}" class="card p-4 flex flex-col gap-3 hover:shadow-cardlg transition-all group relative overflow-hidden">
    ...
    </a>`}var De={id:`dashboard`,title:`Home`,render(){let e=P.get(),t=e.settings.userName||`Guest`,n=e.settings.userAvatar;return`
      ${G({title:`MeetSync`,left:ve(n,t),right:`<button class="icon-btn relative" data-notif aria-label="Notifications">${C(`notifications`)}
      ...
      ${q(`planner`)}`},mount(e){let t=e.root,n=this._state,r=t.querySelector(`[data-calendar]`),i=t.querySelector(`[data-events]`),a=t.querySelector(`[data-month]`),o=t.querySelector(`[data-events-title]`);function s(){let e=Fe(),t=(new Date(n.year,n.month,1).getDay()+6)%7,i=new Date(n.year,n.month+1,0).getDate(),o=new Date(n.year,n.month,0).getDate(),s=p(),l=``;for(let e=t-1;e>=0;e--)J(n.month===0?n.year-1:n.year,n.month===0?11:n.month-1,o-e),l+=`<div class="p-2 rounded-lg text-[13px] text-outline-variant cursor-default text-center">${o-e}</div>`;for(let t=1;t<=i;t++){var u,d,f;let r=J(n.year,n.month,t),i=e[r]||[],a=r===n.selected,o=r===s,c=i.slice(0,3).map(e=>{var t;return((t=v[e.priority])==null?void 0:t.dot)||v.medium.dot}).join(``);l+=`
          ...
          </div>`}let m=7-((t+i)%7||7);for(let e=1;e<=m;e++)J(n.month===11?n.year+1:n.year,n.month===11?0:n.month+1,e),l+=`<div class="p-2 rounded-lg text-[13px] text-outline-variant cursor-default text-center">${e}</div>`;r.innerHTML=l,a.textContent=`${Ne[n.month]} ${n.year}`,c(e)}function c(e){let t=(e[n.selected]||[]).sort((e,t)=>String(e.time).localeCompare(String(t.time)));if(o.textContent=`Events · ${n.selected.slice(8,10)} ${Ne[n.month]}`,!t.length){i.innerHTML=O({icon:`event_available`,title:`No meetings`,message:`Nothing scheduled for this day yet.`,action:`<a href="#/meetings/new" class="btn btn-primary">Plan a meeting</a>`});return}i.innerHTML=t.map(e=>{var t,n,r;return`
      ...
      ${q(`projects`)}`},mount(e){var t;let n=e.root,r=n.querySelector(`[data-grid]`),i=n.querySelector(`[data-search]`);function a(){let e=i.value.trim().toLowerCase(),t=P.get().projects.filter(t=>!e||(t.name+` `+t.description+` `+t.category).toLowerCase().includes(e));if(!t.length){r.innerHTML=O({icon:`folder_open`,title:`No projects found`,message:`Projects appear here once you create them.`,action:`<button class="btn btn-primary" data-new>New Project</button>`});return}r.innerHTML=t.map(e=>{let t=e.color===`secondary`?`bg-secondary-fixed text-on-secondary-fixed`:e.color===`tertiary`?`bg-tertiary-fixed text-on-tertiary-fixed`:`bg-primary-fixed text-on-primary-fixed`;return`
          ...
          </a>`}).join(``)}i.addEventListener(`input`,l(a,150)),(t=n.querySelector(`[data-new]`))==null||t.addEventListener(`click`,()=>{let e=prompt(`New project name:`);if(e&&e.trim()){let t={id:c(`prj`),name:e.trim(),category:`General`,createdAt:f()};P.upsertProject(t),U.enqueueProjectSave(t),w.show(`Project created.`,`success`),a()}}),n.querySelectorAll(`[data-del]`).forEach(e=>{e.addEventListener(`click`,async t=>{t.preventDefault(),t.stopPropagation();let n=e.dataset.del,r=await E.confirm({title:`Delete project`,message:`This deletes the project and all its meetings. Enter your security PIN.`,confirmText:`Delete`,danger:!0,pin:!0});r&&(P.removeProject(n),U.enqueueProjectDelete(n,r),w.show(`Project deleted.`,`success`),a())})}),a();let o=P.subscribe(()=>a());return()=>{o()}}},Re={id:`projectDetail`,title:`Project`,render(e){let t=P.project(e.params.id);if(!t)return`
    ...
    <div style="border:1px solid #e4e1ea;border-left:6px solid ${Ve(e.priority)};border-radius:12px;padding:20px;margin-bottom:16px;break-inside:avoid;">
      ${t.header?`
      <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px;margin-bottom:10px;">
        <div>
          <div style="font-size:11px;font-weight:600;color:${Ue(e.priority)};background:${He(e.priority)};display:inline-block;padding:3px 10px;border-radius:99px;margin-bottom:8px;">${(((n=v[e.priority])==null?void 0:n.label)||`Medium`)+` Priority`}</div>
      ...
      <div style="margin-top:14px;">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:8px;">${e.attachments.filter(e=>e.fileId).slice(0,9).map(e=>`<img src="${Y(ce(e.fileId,160))}" style="width:84px;height:84px;object-fit:cover;border-radius:8px;border:1px solid #e4e1ea;" />`).join(``)}</div>
      </div>`:``}
    </div>`}).join(``)}
    </div>
    <style>.ms-report-body img{max-width:100%;border-radius:8px}.ms-report-body a{color:#000666}</style>`,n}function Y(e){return String(e==null?``:e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Ve(e){return{high:`#ba1a1a`,medium:`#5c1800`,low:`#505f76`}[e]||`#505f76`}function He(e){return{high:`#ffdad6`,medium:`#ffdbd0`,low:`#d3e4fe`}[e]||`#d3e4fe`}function Ue(e){return{high:`#93000a`,medium:`#390c00`,low:`#0b1c30`}[e]||`#0b1c30`}function We(e,t){let n=document.createElement(`a`);n.href=e,n.download=t,document.body.appendChild(n),n.click(),n.remove()}var X=null;window.addEventListener(`beforeinstallprompt`,e=>{e.preventDefault(),X=e,window.dispatchEvent(new CustomEvent(`ms:installable`))});var Ge={canInstall:()=>!!X,async prompt(){return X?(X.prompt(),await X.userChoice,X=null,!0):!1}};function Ke(e){window.addEventListener(`ms:installable`,e),X&&e()}var qe=[{path:`/`,view:De},{path:`/planner`,view:Ie},{path:`/meetings/new`,view:ke},{path:`/meetings/:id`,view:ke},{path:`/projects`,view:Le},{path:`/projects/:id`,view:Re},{path:`/export`,view:ze},{path:`/settings`,view:{id:`settings`,title:`Settings`,render(){var e,t;let n=P.get().settings;return`
      ...
      ${q(`settings`)}`},mount(e){let t=e.root,n=P.get().settings;t.querySelectorAll(`[data-theme]`).forEach(e=>{e.addEventListener(`click`,()=>{let n=e.dataset.theme;P.setSettings({theme:n}),t.querySelectorAll(`[data-theme]`).forEach(e=>{e.className=`flex-1 py-2 text-[12px] font-semibold rounded-lg transition-all ${e.dataset.theme===n?`bg-surface-container-lowest shadow text-on-surface`:`text-on-surface-variant hover:bg-surface-variant`}`})})}),t.querySelectorAll(`[data-accent]`).forEach(e=>{e.addEventListener(`click`,()=>{let n=e.dataset.accent;P.setSettings({accent:n}),t.querySelectorAll(`[data-accent]`).forEach(e=>{e.classList.toggle(`ring-2`,e.dataset.accent===n),e.classList.toggle(`ring-offset-2`,e.dataset.accent===n),e.classList.toggle(`ring-primary`,e.dataset.accent===n),e.classList.toggle(`opacity-60`,e.dataset.accent!==n)})})});let r=t.querySelector(`[data-name]`),i=t.querySelector(`[data-pin]`),a=t.querySelector(`[data-conn]`);t.querySelector(`[data-test]`).addEventListener(`click`,async()=>{let e=t.querySelector(`[data-exec]`).value.trim();e&&se(e),a.innerHTML=`${C(`sync`,`text-[15px] animate-spin`)} Testing connection…`;try{let e=await L.ping();a.innerHTML=`${C(`check_circle`,`text-[16px] text-primary`)} Connected — MeetSync backend v${e.version||`?`} responded OK.`,w.show(`Connection successful.`,`success`)}catch(e){a.innerHTML=`${C(`error`,`text-[16px] text-error`)} ${u(e.message)}`,w.show(`Connection failed.`,`error`)}});let o=t.querySelector(`[data-sync-status]`);function s(){var e;let n=P.get(),r=U.getOps(),i=r.filter(e=>e.status===`pending`||e.status===`running`).length,a=r.filter(e=>e.status===`error`).length;o.innerHTML=`
        ...
        <span class="chip bg-surface-container" data-gid="${u(e.id)}">${u(e.name)}${C(`close`,`text-[14px] cursor-pointer hover:text-error ml-0.5`)}</span>`).join(``);v.innerHTML=e+`<button data-new-group class="chip border border-dashed border-outline-variant hover:bg-surface-container-high">+ New Group</button>`}b(),v.addEventListener(`click`,e=>{let t=e.target.closest(`[data-gid]`);if(t){y=y.filter(e=>e.id!==t.dataset.gid),U.enqueueContactsSave(h),b();return}if(e.target.closest(`[data-new-group]`)){let e=prompt(`Group name:`);e&&e.trim()&&(y.push({id:c(`grp`),name:e.trim(),memberIds:[],createdAt:f()}),b())}});let x=t.querySelector(`[data-install]`);function S(){x.classList.toggle(`hidden`,!Ge.canInstall())}x.addEventListener(`click`,async()=>{await Ge.prompt()&&w.show(`Installing…`,`info`)}),S(),Ke(S);let T=P.subscribe(s);return()=>{T(),l()}}}}];function Je(){let e=location.hash.replace(/^#/,``)||`/`;return e.startsWith(`/`)?e:`/`+e}function Ye(e){let t=e.split(`?`)[0].split(`/`).filter(Boolean);for(let e of qe){let n=e.path.split(`/`).filter(Boolean);if(n.length!==t.length)continue;let r={},i=!0;for(let e=0;e<n.length;e++)if(n[e].startsWith(`:`))r[n[e].slice(1)]=decodeURIComponent(t[e]);else if(n[e]!==t[e]){i=!1;break}if(i)return{view:e.view,params:r}}return{view:De,params:{}}}var Z=null,Q=null;function $(e){location.hash===`#`+e?Xe():location.hash=e}function Xe(){let{view:e,params:t}=Ye(Je());if(Q&&Q.view!==e)try{Q.unmount&&Q.unmount()}catch(e){}if(!Z)return;let n={root:Z,params:t,navigate:$};Z.innerHTML=e.render?e.render(n):``,Q={view:e,params:t,unmount:e.mount?e.mount(n):null},window.scrollTo({top:0,behavior:`instant`in window?`instant`:`auto`})}function Ze(e){return Z=e,window.addEventListener(`hashchange`,Xe),Xe(),{current:()=>Q}}var Qe=document.getElementById(`meta-theme`);function $e(){return window.matchMedia(`(prefers-color-scheme: dark)`).matches}function et(){let{theme:e,accent:t}=P.get().settings,n=e===`dark`||e===`system`&&$e(),r=document.documentElement;r.classList.toggle(`dark`,n),r.dataset.accent=t||`primary`;let i=getComputedStyle(r).getPropertyValue(`--primary`);Qe&&Qe.setAttribute(`content`,`rgb(${i.trim()})`)}et(),P.subscribe(et),window.matchMedia(`(prefers-color-scheme: dark)`).addEventListener(`change`,()=>{P.get().settings.theme===`system`&&et()});var tt=!1;async function nt(){if(!tt){tt=!0,P.set({status:`loading`});try{let e=await L.getDashboard();e&&e.data&&P.hydrate(e.data)}catch(e){P.set({status:`error`});let t=P.get();t.projects.length||t.meetings.length||w.show(`Cannot reach the database. Check the API endpoint in Settings.`,`error`,5e3)}finally{P.set({status:`ready`}),_e()}}}var rt=s({immediate:!0});rt&&rt.then&&rt.then(()=>{});var it=document.getElementById(`app`);it.innerHTML=``,Ce();var at=xe(),ot=()=>at(Se(location.hash));window.addEventListener(`hashchange`,ot),Ze(it),ot(),nt();